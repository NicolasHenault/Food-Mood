<main>
	...
	<div class="text-center p-2 mt-5">
		...
		<h2>Les <?php echo $post_author['count(*)']; ?> articles de : <?php echo utf8_encode($post_author['firstname']); ?> <?php echo utf8_encode($post_author['lastname']); ?></h2>
	...
	<div class="container">
		...
		<section class="my-5">
			...
			foreach ($post_per_authors as $datas) {    	
